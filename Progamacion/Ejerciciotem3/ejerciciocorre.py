...
while True:
    ...
    if opcion == 1:	
        ...
        if opcion_insertar == 1:
            ...
            videojuego=input("Indica el nombre del videojuego")
        ...
        if opcion_comprobar == 1:	
            ...
            if existe_pelicula == True:
                print("La pelicula ya esta en la lista existe")
            else :
            ...
            if existe_serie == True:
                print("La serie ya esta en la lista existe")
            else :
                print("La serie no esta en la lista")
            ...
            if existe_videojuego == True:
                print("El videojuego ya esta en la lista existe")
            else :
                print("El videojuego no esta en la lista")
